...
class Compiler:
    ...
    def write_machine_code_to_binary(self, machine_code_lines, output_file):
        with open(output_file, 'wb') as file:
            for code in machine_code_lines:
                file.write(bytes(code+"\n", encoding="utf-8"))
    
    def write_mif(self, bin_list, output_file):
        with open(output_file, 'w') as f:
            f.write("--MIF data generated by taffarel55 Compiler\n")
            ...
            for i, binary_number in enumerate(bin_list):
                hex_number = hex(int(binary_number, 2))[2:].upper().zfill(4)
                f.write("   {}: {};\n".format(i, hex_number))
            f.write("END;\n")
...
compiler.write_machine_code_to_file(machine_code_lines, program_file+".txt")
compiler.write_machine_code_to_binary(machine_code_lines, program_file+".bin")
compiler.write_mif(machine_code_lines, program_file+".mif")
